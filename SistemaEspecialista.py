...
if resFamilia== 1:
  ...
  resresAnimal = int(input("Você possui animais de estimação?\n"
                    "[1] Sim\n"
                    "[2] Não\n"
                    "Digite sua opção: "))   
...
if resFamilia != 1 or resFilhos !=1 :
  # Pergunta barzinhos    
...
# for keys in ordenado:
  
  

#   porcentagem = calculoPorcentagem(ordenado[keys]) #chamada da função que calcula a porcentagem

#   print(f"De acordo com suas respotas, a probabilidade de você gostar do restaurante {keys} é de {porcentagem}% ")
